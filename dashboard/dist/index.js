...
/***/ function(module, exports) {
	...
	var _user$project$Model$Model = F5(
		function (a, b, c, d, e) {
			return {user: a, userId: b, isLoading: c, error: d, swapCount: e};
		});
	var _user$project$Model$User = F4(
		function (a, b, c, d) {
			return {id: a, firstName: b, lastName: c, avatar: d};
		});

	var _user$project$User$viewUserInfo = function (user) {
		var _p0 = user;
		if (_p0.ctor === 'Just') {
			var _p1 = _p0._0;
			return A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('User info'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
			...
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('User not loaded'),
					_1: {ctor: '[]'}
				});
		}
	};
	...
	var _user$project$Main$getErrorMessage = function (error) {
		var _p0 = error;
		switch (_p0.ctor) {
			case 'Timeout':
			...
			case 'BadUrl':
				return A2(
					_elm_lang$core$Basics_ops['++'],
					'invalid url \'',
					A2(_elm_lang$core$Basics_ops['++'], _p0._0, '\' provided'));
			case 'BadStatus':
				var _p1 = _p0._0;
				return A2(
					_elm_lang$core$Basics_ops['++'],
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Error occured'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{ctor: '[]'},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_user$project$Main$getErrorMessage(error)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
	...
	var _user$project$Main$viewLoading = function (model) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
	...
	var _user$project$Main$viewUser = function (model) {
		var _p2 = model.error;
		if (_p2.ctor === 'Just') {
			return _user$project$Main$viewError(_p2._0);
		} else {
			return model.isLoading ? _user$project$Main$viewLoading(model) : _user$project$User$viewUserInfo(model.user);
		}
	};
	...
	var _user$project$Main$init = function (flags) {
		var initialModel = {user: _elm_lang$core$Maybe$Nothing, userId: 0, isLoading: false, error: _elm_lang$core$Maybe$Nothing, swapCount: flags.swapCount};
		return A2(
			_elm_lang$core$Debug$log,
			'init',
			{ctor: '_Tuple2', _0: initialModel, _1: _elm_lang$core$Platform_Cmd$none});
	};
	var _user$project$Main$UserResult = function (a) {
		return {ctor: 'UserResult', _0: a};
	};
	var _user$project$Main$loadUser = function (id) {
		var url = A2(
			_elm_lang$core$Basics_ops['++'],
			...
			A2(
				...
				'?delay=1'));
		var request = A2(_elm_lang$http$Http$get, url, _user$project$Main$userDecoder);
		return A2(_elm_lang$http$Http$send, _user$project$Main$UserResult, request);
	};
	var _user$project$Main$update = F2(
		function (msg, model) {
			var _p3 = msg;
			if (_p3.ctor === 'LoadUser') {
				var newUserId = model.userId + 1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{userId: newUserId, isLoading: true, error: _elm_lang$core$Maybe$Nothing}),
					_1: _user$project$Main$loadUser(newUserId)
				};
			} else {
				if (_p3._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								user: _elm_lang$core$Maybe$Just(_p3._0._0),
								isLoading: false,
	...
	var _user$project$Main$loadFirstUser = A2(
		_elm_lang$core$Task$perform,
		_elm_lang$core$Basics$identity,
		_elm_lang$core$Task$succeed(_user$project$Main$LoadUser));
			...
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Elm HTTP request playground'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Load next user'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: _user$project$Main$viewUser(model),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: _elm_lang$html$Html$text(
											A2(
												_elm_lang$core$Basics_ops['++'],
												'parts of this application have been reloaded ',
												A2(
													_elm_lang$core$Basics_ops['++'],
													_elm_lang$core$Basics$toString(model.swapCount),
													' times'))),
										_1: {ctor: '[]'}
									}),
								_1: {
	...
	var _user$project$Main$main = _elm_lang$html$Html$programWithFlags(
		...
		A2(
			...
			A2(_elm_lang$core$Json_Decode$field, 'swapCount', _elm_lang$core$Json_Decode$int)));
